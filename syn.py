...
def syn():
    ...
    header, rows, column_map = read_csv(join(FOLDER_PATH, 'Syn.csv'))

    before_date = datetime.strptime('2018-11-03 11:28:00.0', time_format)
    after_date = datetime.strptime('2018-11-03 17:35:00.0', time_format)
