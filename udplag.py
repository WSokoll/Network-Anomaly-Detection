...
def udplag():
    ...
    header, rows, column_map = read_csv(join(FOLDER_PATH, 'UDPLag.csv'))

    before_date = datetime.strptime('2018-11-03 11:14:00.0', time_format)
    after_date = datetime.strptime('2018-11-03 11:24:00.0', time_format)
