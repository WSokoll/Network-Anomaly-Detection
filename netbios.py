...
def netbios():
    ...
    header, rows, column_map = read_csv(join(FOLDER_PATH, 'NetBIOS.csv'))

    before_date = datetime.strptime('2018-11-03 10:00:00.0', time_format)
    after_date = datetime.strptime('2018-11-03 10:09:00.0', time_format)
