...
def ldap():
    ...
    header, rows, column_map = read_csv(join(FOLDER_PATH, 'LDAP.csv'))

    before_date = datetime.strptime('2018-11-03 10:21:00.0', time_format)
    after_date = datetime.strptime('2018-11-03 10:30:00.0', time_format)
