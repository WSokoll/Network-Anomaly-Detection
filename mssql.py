...
def mssql():
    ...
    header, rows, column_map = read_csv(join(FOLDER_PATH, 'MSSQL.csv'))

    before_date = datetime.strptime('2018-11-03 10:33:00.0', time_format)
    after_date = datetime.strptime('2018-11-03 10:42:00.0', time_format)
